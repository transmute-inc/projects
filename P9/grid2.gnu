...
set y2label "Proton Current - microamps" offset -1,0 tc "web-blue"
set y2tics nomirror tc "web-blue"
set autoscale y2

set key left top

plot './I.dat' using 1:2 with linespoints title 'pressure' axes x1y1 lw 2 lc 'web-green', \
...
plot './I.dat' using 1:4 with linespoints title 'Grid'    axes x1y2 lw 2 lc 'red', \
