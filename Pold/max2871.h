...
// register 2 masks
#define LDS (0 << 31) //Lock detect speed adjustment: 0 fPFD < 32 MHz, 1 pPFD > 32 MHz
...
#define MUTEDEL (0 << 17) // Delay LD to MTLD function to prevent ﬂickering
...
#define ADCS (0 << 6) // Starts ADC mode
